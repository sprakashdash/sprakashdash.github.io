...
title: about
permalink: /
subtitle: <em>"Mathematical theories seem beautiful, but Physics "is" beautiful because<br>the universe has realised the mathematical theory in itself..."</em>

profile:
  align: right
  image: 1000011868.jpg
  image_circular: true # crops the image to make it circular
  more_info: >
    Center of AI-Fundamentals,
...
Hi I am a final year PhD student in the Department of Computer Science at the University of Manchester. My PhD work focuses on understanding the training dynamics of LLMs under [natural gradients](https://www.emergentmind.com/topics/natural-gradient-descent) and propose scalable and more generalizable and robus training methods. "Natural" means it estimates the curvature of the loss function induced in the parameter space to estimate the sensitivity of each parameter of LLMs (and "accelerates" gradient descent).
